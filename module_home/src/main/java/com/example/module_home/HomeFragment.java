...
import com.example.module_home.adapters.ArticleListAdapter;
...
public class HomeFragment extends BaseFragment<HomePresenter, HomeIView, HomeModel>
    ...
    @BindView(R2.id.fragment_home_recyc)
    public RecyclerView recycView;
    @BindView(R2.id.fragment_home_srl)
    ...
    private void initBanner() {
        ...
        banner.setOnBannerListener(position -> {
            ...
            //WebActivity.skip(getContext(), bean.getUrl(), bean.getTitle());
            ARouter.getInstance().build("/h5/WebActivity")
                    .withString("url", bean.getUrl()).withString("title", bean.getTitle())
