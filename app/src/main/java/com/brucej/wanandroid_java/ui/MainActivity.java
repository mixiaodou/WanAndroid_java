        ...
        switch (id) {
            case R.id.nav_main_home:
                if (fragment == null) {
                    ...
                    fragment = (Fragment) ARouter.getInstance().build("/home/HomeFragment").navigation();
            ...
            case R.id.nav_main_knowledge:
                if (fragment == null) {
                    ...
                    fragment = (Fragment) ARouter.getInstance().build("/knowledge/KnowledgeFragment").navigation();
                    fragments.put(id, fragment);
                }
                switchTittle("知识");
                break;
